...
<div id="projectListWrap">
	<div class="projectListHeader">
		<div class="categoryName"><h2>여행</h2></div>
	...
	<div class="invest_list">
		...
		<div class="invest_box invest_item<%= i+1 %>">
			<div class="invest_img">
				<a class="invest_imgtag" href="/RewardBook/p_sel?category=travel&p_no=<%= list.get(i).getP_no() %>"><img src="/RewardBook/resources/images/bgimg.jpg"></a></div>
