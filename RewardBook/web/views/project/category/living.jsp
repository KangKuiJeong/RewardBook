	...
	<div class="projectListHeader">
		<div class="searchArea">
			...
			<form class="searchForm" action="/RewardBook/indexSearch">
				...
				<button class="searchButton" type="button" onclick="seachSubmit();"><i class="icon search"></i></button>
				</label>
			</form>
		</div>
	</div>
			...
			success : function(data) { 
				...
				for(var i = 0; i < 3; i++){
					...
					$(".invest_list").append(
						...
						+ "<div class='invest_img'>"
						+ "<a class='invest_imgtag' href='/RewardBook/p_sel?p_no="+ json.list[count].no +"'><img src='/RewardBook/resources/upfiles/project/" + json.list[count].img + "'></a></div>"
						+ "<div class='invest_title'>"
