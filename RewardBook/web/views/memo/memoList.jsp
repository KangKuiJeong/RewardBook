	...
	<div class="invest_list">
		...
		<div class="invest_box invest_item<%= i+1 %>">
			<div class="invest_img">
				<a class="invest_imgtag" href="/RewardBook/mselect?p_no=<%= list.get(i).getP_no() %>"><img src="/RewardBook/resources/images/bgimg.jpg"></a></div>
			<div class="invest_title">
				<div class="investap"><a href="/RewardBook/mselect?p_no=<%= list.get(i).getP_no() %>" class="invest_titlelink"><p><%= list.get(i).getP_title() %></p></a></div>		
			...
			<input class="memobt" type="button" value="메모"></input>
		</div>
			...
			success : function(data) { 
				...
				for(var i = 0; i < 3; i++){
					...
					$(".invest_list").append(
						...
						+ "<div class='invest_img'>"
						+ "<a class='invest_imgtag' href='/RewardBook//mselect?p_no="+ json.list[count].no +"'><img src='/RewardBook/resources/images/bgimg.jpg'></a></div>"
						+ "<div class='invest_title'>"
						+ "<a href='/RewardBook/mselect?p_no="+ json.list[count].no +"' class='invest_titlelink'><p>"+ decodeURIComponent(json.list[count].title).replace(/\+/gi, " ") +"</p></a>"
						+ "<div class='invest_name'>"
