...
<body>
	...
	<div id="personalUpdateContainer">
			<p class="title">개인회원 정보수정</p>
			...
			<form action="/RewardBook/m_pupdate" method="post" id="pUdateForm">
		...
		<form id="personalDelForm" action="/RewardBook/m_pdel" method="post">
		...
		<script>
			...
			//회원탈퇴용 자바스크립트
			personalDelForm.onsubmit = function(e) {
