...
<script type="text/javascript">
	...
	$(function() {
		...
		$(".main_area2_section2 .search .submit").on("click", function() {
			location.href="/RewardBook/iq_list_a?" + linkString(1);
		});
		...
		$(".main_area3_section1 .pageButton#page1").on("click", function() {
			location.href="/RewardBook/iq_list_a?" + linkString(<%= currentPage - 2 %>);
		});

		$(".main_area3_section1 .pageButton#page2").on("click", function() {
			location.href="/RewardBook/iq_list_a?" + linkString(<%= currentPage - 1 %>);
		});
		...
		$(".main_area3_section1 .pageButton#page6").on("click", function() {
			location.href="/RewardBook/iq_list_a?" + linkString(<%= maxPage %>);
		});
