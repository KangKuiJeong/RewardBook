...
.main_area3_section1 .info .no {
	width : 800px;
	float : left;
	clear : both;
}
.main_area3_section1 .info .name, .main_area3_section1 .info .date, .main_area3_section1 .info .aname, .main_area3_section1 .info .rdate {
	width : 400px;
	float : left;
	clear : none;
}
...
.main_area3_section1 .info div .input input[name=no], .main_area3_section1 .info div .input input[name=name], .main_area3_section1 .info div .input input[name=date], .main_area3_section1 .info div .input input[name=aname], .main_area3_section1 .info div .input input[name=rdate] {
	width : 250px;
}
...
.main_area3_section1 .info .no .input, .main_area3_section1 .info .name .input, .main_area3_section1 .info .date .input, .main_area3_section1 .info .aname .input, .main_area3_section1 .info .rdate .input {
	width : 300px;
}
