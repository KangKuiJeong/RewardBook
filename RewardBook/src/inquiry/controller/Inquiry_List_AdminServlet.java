...
/**
 * Servlet implementation class Inquiry_List_AdminServlet
 */
@WebServlet("/iq_list_a")
public class Inquiry_List_AdminServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Inquiry_List_AdminServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Inquiry> list = iqservice.pageSelect(movePage, limit, check1, check2, check3, check4, select1, text1);
		int pageCount = iqservice.pageCount(check1, check2, check3, check4, select1, text1);
		...
		view = request.getRequestDispatcher("/views/admin/adminInquiryList.jsp");
