...
/**
 * Servlet implementation class Mypage_Pay_ProjectListServlet
 */
@WebServlet("/pay_list")
public class Mypage_Pay_ProjectListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Mypage_Pay_ProjectListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Project> list = mypageservice.payprojectList(uNo);
