...
public class MypageDao {
	...
	public ArrayList<Project> myprojectList(Connection conn, String uNo) {
	      ...
	      String query = "select to_number(round(p_edate - p_sdate)),u_name, p_no, u_no, p_title, p_category, p_story, p_img, p_info, p_nprice, p_tprice, p_sdate, p_edate, p_secondary, p_ddate, p_count, p_permission, p_pdate, p_return from project join users using(u_no) where u_no = ?";
	...
	//유저 프로젝트 목록 조회
	public ArrayList<Project> userPList(Connection conn, String uNo) {
		ArrayList<Project> list = new ArrayList<Project>();
	      PreparedStatement pstmt = null;
	      ResultSet rset = null;
	      
	      String query = "select to_number(round(p_edate - p_sdate)),u_name, p_no, u_no, p_title, p_category, p_story, p_img, p_info, p_nprice, p_tprice, p_sdate, p_edate, p_secondary, p_ddate, p_count, p_permission, p_pdate, p_return from project join users using(u_no) where p_permission = 'Y' and u_no = ?";
	...
	//후원한 프로젝트 목록 조회
	public ArrayList<Project> payprojectList(Connection conn, String uNo) {
		ArrayList<Project> list = new ArrayList<Project>();
	      PreparedStatement pstmt = null;
	      ResultSet rset = null;
	      
	      String query = "select to_number(round(p_edate - p_sdate)),u_name, p_no, u_no, p_title, p_category, p_story, p_img, p_info, p_nprice, p_tprice, p_sdate, p_edate, p_secondary, p_ddate, p_count, p_permission, p_pdate, p_return from project join users using(u_no) where p_no in (select p_no from payment where u_no = ?)";
	...
	//리뷰 리스트
	public ArrayList<Project> myreviewList(Connection conn, String uNo) {
		ArrayList<Project> list = new ArrayList<Project>();
	      PreparedStatement pstmt = null;
	      ResultSet rset = null;
	...
	public ArrayList<Project> userRList(Connection conn, String uNo) {
		ArrayList<Project> list = new ArrayList<Project>();
	      PreparedStatement pstmt = null;
	      ResultSet rset = null;
