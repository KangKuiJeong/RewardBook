...
public class Memo implements Serializable {
	...
	public Memo(String m_no, String p_no, String u_no, String m_text, Date m_date, String p_title, String p_category,
			String p_story, String p_img, String p_info, int p_nprice, int p_tprice, java.sql.Date p_sdate,
			java.sql.Date p_edate, String p_secondary, java.sql.Date p_ddate, int p_count, String p_permission,
			java.sql.Date p_pdate, String p_return, int p_rdate, String u_name, int time) {
		super();
		this.m_no = m_no;
		this.p_no = p_no;
		this.u_no = u_no;
	...
	public String toString() {
		return "Memo [m_no=" + m_no + ", p_no=" + p_no + ", u_no=" + u_no + ", m_text=" + m_text + ", m_date=" + m_date
				+ ", p_title=" + p_title + ", p_category=" + p_category + ", p_story=" + p_story + ", p_img=" + p_img
				+ ", p_info=" + p_info + ", p_nprice=" + p_nprice + ", p_tprice=" + p_tprice + ", p_sdate=" + p_sdate
				+ ", p_edate=" + p_edate + ", p_secondary=" + p_secondary + ", p_ddate=" + p_ddate + ", p_count="
				+ p_count + ", p_permission=" + p_permission + ", p_pdate=" + p_pdate + ", p_return=" + p_return
				+ ", p_rdate=" + p_rdate + ", u_name=" + u_name + ", time=" + time + "]";
	}
