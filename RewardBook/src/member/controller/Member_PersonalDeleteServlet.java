...
/**
 * Servlet implementation class Member_PersonalDeleteServlet
 */
@WebServlet("/m_pdel")
public class Member_PersonalDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Member_PersonalDeleteServlet() {
        super();
