...
/**
 * Servlet implementation class Member_PersonalUpdateServlet
 */
@WebServlet("/m_pupdate")
public class Member_PersonalUpdateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Member_PersonalUpdateServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		member.setJob(request.getParameter("jobSelect"));
		...
		int result = mservice.updateMemberPersonal(member);
