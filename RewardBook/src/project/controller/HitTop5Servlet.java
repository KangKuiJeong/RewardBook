...
/**
 * Servlet implementation class HitTop5Servlet
 */
@WebServlet("/hipTop5")
public class HitTop5Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HitTop5Servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 인덱스 조회수 top5
		ArrayList<Project> list = new ProjectIndexService().hitTop5();
		// 전송할 json 객체 생성
