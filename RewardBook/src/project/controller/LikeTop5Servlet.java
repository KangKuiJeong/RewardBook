...
/**
 * Servlet implementation class LikeTop5Servlet
 */
@WebServlet("/likeTop5")
public class LikeTop5Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LikeTop5Servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// like top5
				ArrayList<Project> list = new ProjectIndexService().likeTop5();
				// 전송할 json 객체 생성
				...
				for (Project project : list) {
					...
					job.put("like_tprice", project.getP_tprice());
					job.put("like_count", project.getP_count());
